...
function export_order_bu_to_excel() {
	...
	$sql = 'SELECT site.name as site_name, ' .
		   ...
		   'AND custords_product.direct_forwarding = 1 ';
...
header("Content-disposition: attachment; filename=commandes_bu_".date("Ymd").".xls");

session_start();

print export_order_bu_to_excel();
