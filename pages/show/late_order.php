...
<html>
<head>
	<title>ELBA - Appli Cellules - Commandes en retard</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<link href="../../css/style.css" rel="stylesheet" type="text/css">
</HEAD>
<BODY class="main_body">
<FORM NAME='mainForm' ACTION='late_order.php' METHOD='POST'>
<TABLE class="normal">
	<TR>
		<TD align="center">
			<TABLE class="normal">
				<TR>
					<TD class="main_image"><A HREF="../print/late_order.php" TARGET="_self"><img src="../../image/printer_little.jpg" ALT="Impression des commandes en retard"></A></TD>
					<TD class="field_separator"></TD>
				    <TD class="main_image"><A HREF="../export/late_order.php" TARGET="_self"><img src="../../image/excel_little.jpg" alt="Exportation Excel des commandes en retard"></A></TD>
					<TD class="field_separator"></TD>
					...
					<TD class="field_separator"></TD>
					<TD class="main_bottom_text" width="150"><A HREF="late_order.php" target="_self">Mettre &agrave; jour</A></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
...
<TABLE class="normal">
	<TR>
		<TD><iframe src="late_order_result.php<?php 
