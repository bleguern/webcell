...
<html>
<head>
	<title>ELBA - Appli Cellules - Commandes en retard en rupture</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<link href="../../css/style.css" rel="stylesheet" type="text/css">
</HEAD>
<BODY class="main_body">
<FORM NAME='mainForm' ACTION='late_order_out.php' METHOD='POST'>
<TABLE class="normal">
	<TR>
		<TD align="center">
			<TABLE class="normal">
				<TR>
					<TD class="main_image"><A HREF="../print/late_order_out.php" TARGET="_self"><img src="../../image/printer_little.jpg" ALT="Impression des commandes en retard en rupture"></A></TD>
					<TD class="field_separator"></TD>
				    <TD class="main_image"><A HREF="../export/late_order_out.php" TARGET="_self"><img src="../../image/excel_little.jpg" alt="Exportation Excel des commandes en retard en rupture"></A></TD>
					<TD class="field_separator"></TD>
				    <TD class="main_title_text">Commandes en retard en rupture : lignes <input type="text" name="count" value="..." class="count"> / references <input type="text" name="count2" value="..." class="count"></TD>
					<TD class="field_separator"></TD>
					<TD class="main_bottom_text" width="150"><A HREF="late_order_out.php" target="_self">Mettre &agrave; jour</A></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
...
<TABLE class="normal">
	<TR>
		<TD><iframe src="late_order_out_result.php<?php 
