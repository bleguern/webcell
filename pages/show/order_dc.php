		...
		<TD align="center">
			<TABLE class="normal">
				<TR>
					...
					<TD class="field_separator"></TD>
				    <TD class="main_title_text">Commandes CDC : lignes <input type="text" name="count" value="..." class="count"> / references <input type="text" name="count2" value="..." class="count"></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
...
<TABLE class="normal">
	<TR>
		<TD><iframe src="order_dc_result.php<?php 
