...
function get_late_order_without_blocked_list() {
...
<FORM NAME="resultForm" ACTION="late_order_without_blocked_result.php" METHOD="POST">
<?php
start_loading();
$count = get_late_order_without_blocked_list();
stop_loading();
?>
