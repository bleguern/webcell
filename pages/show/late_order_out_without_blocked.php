...
<FORM NAME='mainForm' ACTION='late_order_out_without_blocked.php' METHOD='POST'>
<TABLE class="normal">
	<TR>
		<TD align="center">
			<TABLE class="normal">
				<TR>
					<TD class="main_image"><A HREF="../print/late_order_out_without_blocked.php" TARGET="_self"><img src="../../image/printer_little.jpg" ALT="Impression des commandes en retard non bloqu&eacute;es et en rupture"></A></TD>
					<TD class="field_separator"></TD>
				    <TD class="main_image"><A HREF="../export/late_order_out_without_blocked.php" TARGET="_self"><img src="../../image/excel_little.jpg" alt="Exportation Excel des commandes en retard non bloqu&eacute;es et en rupture"></A></TD>
					<TD class="field_separator"></TD>
				    <TD class="main_title_text">Cdes. en retard non bloqu&eacute;es et en rupture : lignes <input type="text" name="count" value="..." class="count"> / references <input type="text" name="count2" value="..." class="count"></TD>
					<TD class="field_separator"></TD>
					<TD class="main_bottom_text" width="150"><A HREF="late_order_out_without_blocked.php" target="_self">Mettre &agrave; jour</A></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
		...
		<TD align="center">
			<TABLE class="normal">
				<TR>
					...
					<TD class="main_sub_section_text">- <A HREF="late_order_without_blocked.php?history=<?php echo get_php_self(); ?>" TARGET="_self">Commandes non bloqu&eacute;es</A> -</TD>
...
<TABLE class="normal">
	<TR>
		<TD><iframe src="late_order_out_without_blocked_result.php<?php 
