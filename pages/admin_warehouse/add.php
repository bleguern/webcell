...
function add_warehouse() {
	if (($_REQUEST['name'] == '') ||
		...
		$sql_query = 'INSERT INTO warehouse (id, trigram, name) ' .
					 'VALUES ' .
					 '(NULL, ' .
		...
		if (mysql_insert_query($sql_query)) {
			mysql_save_log('ADD_WAREHOUSE', 'ID : '.mysql_insert_id());
			header('Location: index.php');
		} else {
			mysql_save_sql_error(get_php_self(), 'Ajouter un entrep&ocirc;t', $sql_query, mysql_errno(), mysql_error());
			$_REQUEST['message'] = 'Erreur : entrep&ocirc;t non ajout&eacute;!';
		}
	}
}
?>
...
<html>
<head>
	<title>ELBA - Appli Cellules - Ajouter un entrep&ocirc;t</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<link href="../../css/style.css" rel="stylesheet" type="text/css">
</HEAD>
<BODY class="main_body">
<FORM NAME='addWarehouseForm' ACTION='add.php' METHOD='POST'>
<TABLE class="normal">
	<TR>
		<TD class="main_title_text">Ajouter un entrep&ocirc;t</TD>
	</TR>
	<TR>
	...
	<TR>
		<TD>
			...
			<TABLE class="normal">
				<TR align="center">
					<TD>
						<INPUT TYPE='submit' NAME='add' VALUE='ajouter' ALT='Ajouter un entrep&ocirc;t'>
					</TD>
				</TR>
				<TR>
					<TD class="max_separator"></TD>
