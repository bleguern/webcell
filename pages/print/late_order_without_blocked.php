...
function print_late_order_without_blocked() {
	...
	print_pdf('Commandes en retard non bloquees : '.$_SESSION['site_name'], '', $_SERVER['REMOTE_ADDR'], $header, $data);
}
...
print_late_order_without_blocked();
